...
/** @var Xbsmodgen\Common\Configurator $configurator */
$configurator = new Xbsmodgen\Common\Configurator();

/** @var \XoopsModules\Xbsmodgen\Common\Migrate $migrator */
$migrator = new \XoopsModules\Xbsmodgen\Common\Migrate($configurator);
