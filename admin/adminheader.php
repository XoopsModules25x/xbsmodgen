...
function xoops_module_admin_menu($currentoption = 0, $breadcrumb = '')
{
    ...
    if (file_exists(XOOPS_ROOT_PATH . '/modules/' . $modDir . '/language/' . $xoopsConfig['language'] . '/admin.php')) {
        ...
        require_once XOOPS_ROOT_PATH . '/modules/' . $modDir . '/english/admin.php';
    }
...
if (file_exists(XOOPS_ROOT_PATH . '/modules/' . $modDir . '/language/' . $modLang . '/main.php')) {
    require_once XOOPS_ROOT_PATH . '/modules/' . $modDir . '/language/' . $modLang . '/main.php';
} else {
    /**
     * @ignore
     */
...
if (file_exists(XOOPS_ROOT_PATH . '/modules/' . $modDir . '/language/' . $modLang . '/admin.php')) {
    ...
    require_once XOOPS_ROOT_PATH . '/modules/' . $modDir . '/language/' . $modLang . '/admin.php';
